...
app.use(express.static(__dirname + '/angular')); 	// set the static files location /public/img will be /img for users
...
var notes = [
  {id: 1, label: 'First Note', author: 'Manjit'},
  {id: 2, label: 'Second Note', author: 'Kumar'},
  {id: 3, label: 'Middle Note', author: 'Someone'},
  {id: 4, label: 'Last Note', author: 'Manjit'},
  {id: 5, label: 'Really the last Note', author: 'Kumar'}
